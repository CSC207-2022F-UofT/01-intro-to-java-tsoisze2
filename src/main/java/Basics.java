...
public class Basics {
    ...
    public static String split(String to_split) {
        ...
        // Use String.split() to get all 7 words
        String[] arr_of_words = to_split.split(" ");

        // Append the first letter of each word to ret
        for (int i = 0; i < 7; i++) {
            String word = arr_of_words[i];
    ...
    public static int oddSum(int[] arr) {
        ...
        // Find the length of the array, continue if length > 1
